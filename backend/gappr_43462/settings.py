"""
Django settings for gappr_43462 project.
...
WSGI_APPLICATION = 'gappr_43462.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gappr_43462 API",
    "DESCRIPTION": "API documentation for gappr_43462 App",
    "VERSION": "v1",
}
